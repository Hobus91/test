...
function OpenAmbulanceActionsMenu()
  ...
  if PlayerData.job ~= nil and PlayerData.job.name == 'ambulance' and PlayerData.job.grade_name == 'boss' then
...
function OpenMobileAmbulanceActionsMenu()
    ...
    css = 'fgmd',
		...
		align    = 'top-left',
		elements = {
      {label = _U('ems_facture'), value = 'billing'},
        ...
        function(data, menu)
          ...
          if amount == nil or amount < 0 then
            ...
            if closestPlayer == -1 or closestDistance > 3.0 then
              ...
              TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_ambulance', _U('ambulo'), amount)
            end
          end
        end,
      function(data, menu)
