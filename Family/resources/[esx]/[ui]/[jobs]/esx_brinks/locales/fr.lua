...
Locales['fr'] = {
	...
	['brinks_client'] = 'Client Brinks',
	['transforming_in_progress'] = 'Transformation en cours',
	['brinks_taken'] = 'Vous êtes en train de récolter',
	['press_traitement'] = 'Appuyez sur ~INPUT_CONTEXT~ pour transformer',
	['press_traitement_raffine'] = 'Appuyez sur ~INPUT_CONTEXT~ pour transformer',
	['press_collect'] = 'Appuyez sur ~INPUT_CONTEXT~ pour récolter',
	['press_transfo'] = 'Appuyez sur ~INPUT_CONTEXT~ pour récolter',
	['press_sell'] = 'Appuyez sur ~INPUT_CONTEXT~ pour vendre',
	['no_brinks_sale'] = 'Vous êtes à sec',
	['no_vin_sale'] = 'Vous n\'avez plus ou pas assez de vin',
	['not_enough_brinks'] = 'Vous êtes à sec',
	['no_jus_sale_brinks'] = 'Vous êtes à sec',
	['grand_cru'] = '~g~Génial, un grand cru !~w~',
	['no_product_sale'] = 'Vous n\'avez plus de produits',
	['press_traitement_brinks'] = 'Appuyez sur ~INPUT_CONTEXT~ pour transformer',
	['used_petrole'] = 'Vous avez bu du jus de raisin',
