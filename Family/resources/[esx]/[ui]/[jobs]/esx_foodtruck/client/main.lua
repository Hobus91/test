...
function OpenVenteZone()
	TriggerServerEvent('esx_foodtruck:ZoneVenteStart')
end
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_foodtruck', _U('billing'), amount)
        end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_foodtruck:getFridgeStockItems', function(items)
    ...
    ESX.UI.Menu.Open(
      ...
      {
        title    = _U('foodtruck_fridge_stock'),
        elements = elements
      },
      function(data, menu)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_foodtruck:getFridgeStockItem', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_foodtruck:putFridgeStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_foodtruck:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_foodtruck:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_foodtruck:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
AddEventHandler('esx_foodtruck:hasEnteredMarker', function(zone)
    ...
    if zone == 'Vente' then
      CurrentAction     = 'zone_vente'
      CurrentActionMsg  = _U('open_vente')
      CurrentActionData = {}
    end
...
AddEventHandler('esx_foodtruck:hasExitedMarker', function(zone)
    ...
    if zone == 'Vente' then
      TriggerServerEvent('esx_foodtruck:ZoneVenteStop')
    end
  ...
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'zone_vente' then
          OpenVenteZone()
        end
    ...
    if IsControlJustReleased(0,  Keys['F6']) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'foodtruck_actions') then
...
AddEventHandler('esx_foodtruck:teleportMarkers', function(position)
  ...
  while true do
    ...
    if IsJobTrue() then
        ...
        if IsControlJustReleased(0, Keys["E"]) and isInPublicMarker then
          TriggerEvent('esx_foodtruck:teleportMarkers', position)
        end
