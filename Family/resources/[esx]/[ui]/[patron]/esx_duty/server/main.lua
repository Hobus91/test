...
RegisterServerEvent('duty:foodtruck')
AddEventHandler('duty:foodtruck', function(job)

        local _source = source
        local xPlayer = ESX.GetPlayerFromId(_source)

    if xPlayer.job.name == 'foodtruck' and xPlayer.job.grade == 1 then
        xPlayer.setJob('offfoodtruck', 1)
    elseif xPlayer.job.name == 'foodtruck' and xPlayer.job.grade == 2 then
        xPlayer.setJob('offfoodtruck', 2)
    elseif xPlayer.job.name == 'foodtruck' and xPlayer.job.grade == 3 then
        xPlayer.setJob('offfoodtruck', 3)
    elseif xPlayer.job.name == 'foodtruck' and xPlayer.job.grade == 0 then
        xPlayer.setJob('offfoodtruck', 0)
    end

    if xPlayer.job.name == 'offfoodtruck' and xPlayer.job.grade == 1 then
        xPlayer.setJob('foodtruck', 1)
    elseif xPlayer.job.name == 'offfoodtruck' and xPlayer.job.grade == 2 then
        xPlayer.setJob('foodtruck', 2)
    elseif xPlayer.job.name == 'offfoodtruck' and xPlayer.job.grade == 3 then
        xPlayer.setJob('foodtruck', 3)
    elseif xPlayer.job.name == 'offfoodtruck' and xPlayer.job.grade == 0 then
        xPlayer.setJob('foodtruck', 0)
    end
end)

RegisterServerEvent('duty:fermier')
AddEventHandler('duty:fermier', function(job)

        local _source = source
        local xPlayer = ESX.GetPlayerFromId(_source)

    if xPlayer.job.name == 'fermier' and xPlayer.job.grade == 1 then
        xPlayer.setJob('offfermier', 1)
    elseif xPlayer.job.name == 'fermier' and xPlayer.job.grade == 2 then
        xPlayer.setJob('offfermier', 2)
    elseif xPlayer.job.name == 'fermier' and xPlayer.job.grade == 3 then
        xPlayer.setJob('offfermier', 3)
    elseif xPlayer.job.name == 'fermier' and xPlayer.job.grade == 0 then
        xPlayer.setJob('offfermier', 0)
    end

    if xPlayer.job.name == 'offfermier' and xPlayer.job.grade == 1 then
        xPlayer.setJob('fermier', 1)
    elseif xPlayer.job.name == 'offfermier' and xPlayer.job.grade == 2 then
        xPlayer.setJob('fermier', 2)
    elseif xPlayer.job.name == 'offfermier' and xPlayer.job.grade == 3 then
        xPlayer.setJob('fermier', 3)
    elseif xPlayer.job.name == 'offfermier' and xPlayer.job.grade == 0 then
        xPlayer.setJob('fermier', 0)
    end
end)

RegisterServerEvent('duty:brinks')
AddEventHandler('duty:brinks', function(job)

        local _source = source
        local xPlayer = ESX.GetPlayerFromId(_source)

    if xPlayer.job.name == 'brinks' and xPlayer.job.grade == 1 then
        xPlayer.setJob('offbrinks', 1)
    elseif xPlayer.job.name == 'brinks' and xPlayer.job.grade == 2 then
        xPlayer.setJob('offbrinks', 2)
    elseif xPlayer.job.name == 'brinks' and xPlayer.job.grade == 3 then
        xPlayer.setJob('offbrinks', 3)
    elseif xPlayer.job.name == 'brinks' and xPlayer.job.grade == 0 then
        xPlayer.setJob('offbrinks', 0)
    end

    if xPlayer.job.name == 'offbrinks' and xPlayer.job.grade == 1 then
        xPlayer.setJob('brinks', 1)
    elseif xPlayer.job.name == 'offbrinks' and xPlayer.job.grade == 2 then
        xPlayer.setJob('brinks', 2)
    elseif xPlayer.job.name == 'offbrinks' and xPlayer.job.grade == 3 then
        xPlayer.setJob('brinks', 3)
    elseif xPlayer.job.name == 'offbrinks' and xPlayer.job.grade == 0 then
