...
RegisterNUICallback('deposit', function(data)
  if nearBank() == true then
	 TriggerServerEvent('bank:deposit', tonumber(data.amount), true)
  elseif nearATM() == true then
   TriggerServerEvent('bank:deposit', tonumber(data.amount), false)
 end
end)
...
RegisterNUICallback('transfer', function(data)
  if nearBank() == true then
	 TriggerServerEvent('bank:transfer', data.to, data.amountt, true)
	elseif nearATM() == true then
    riggerServerEvent('bank:transfer', data.to, data.amountt, false)
  end
end)
