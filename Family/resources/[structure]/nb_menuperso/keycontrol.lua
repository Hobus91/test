...
--------------------------------------------------------------------------------------------
		...
		if (IsControlPressed(0, Keys["F6"]) and PlayerData.job ~= nil and PlayerData.job.name == 'cnn' and not ESX.UI.Menu.IsOpen('default', 'fg_reporterjob', 'cnn_actions_menu') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
  	...
  	if (IsControlPressed(0, Keys["F6"]) and PlayerData.job ~= nil and PlayerData.job.name == 'cnn' and ESX.UI.Menu.IsOpen('default', 'fg_reporterjob', 'cnn_actions_menu') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			GUI.Time = GetGameTimer()
		end
...
--------------------------------------- MANETTE
		...
		if (IsControlPressed(1, Keys["SPACE"]) and IsControlPressed(0, Keys["DOWN"]) and PlayerData.job ~= nil and PlayerData.job.name == 'cnn' and not ESX.UI.Menu.IsOpen('default', 'fg_reporterjob', 'cnn_actions_menu') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			TriggerEvent('NB:openMenuCnn')
			GUI.Time  = GetGameTimer()
		...
		if (IsControlPressed(1, Keys["SPACE"]) and IsControlPressed(0, Keys["DOWN"]) and PlayerData.job ~= nil and PlayerData.job.name == 'cnn' and ESX.UI.Menu.IsOpen('default', 'fg_reporterjob', 'cnn_actions_menu') and (GetGameTimer() - GUI.Time) > 150) then
			TriggerEvent('NB:closeAllSubMenu')
			TriggerEvent('NB:closeAllMenu')
			GUI.Time  = GetGameTimer()
		end
