webpackJsonp([0], [, , , , , , , function(t, e, n) {
    ...
    var s = n(2),
        ...
        g = function() {
            ...
            return d()(t, [{
                        ...
                        return i.a.wrap(function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    ...
                                    break;
                                case 3:
                                    return n = t.sent, console.log("PhneAPI startCall"), t.abrupt("return", this.post("startCall", {
                                        numero: e,
                                        rtcOffer: n
                                    }));
                                case 8:
                        ...
                        return i.a.wrap(function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    ...
                                    break;
                                case 4:
                                    return n = t.sent, console.log("PhneAPI acceptCall"), t.abrupt("return", this.post("acceptCall", {
                                        infoCall: e,
                                        rtcAnswer: n
                                    }));
                                case 9:
                ...
                key: "onacceptCall",
                value: function(t) {
                    console.log("onacceptCall " + t.initiator), !0 === t.initiator && this.voiceRTC.onReceiveAnswer(t.infoCall.rtcAnswer), m.a.commit("SET_APPELS_INFO_IS_ACCEPTS", !0)
                }
            }, {
                key: "onrejectCall",
                value: function(t) {
                    m.a.commit("SET_APPELS_INFO", null)
                }
            }, {
                key: "ontchat_receive",
                value: function(t) {
                ...
                key: "rtcSendAnswer",
                value: function(t) {
                    this.post("gcPhoneRTC_send_answer", t)
                }
            }, {
                key: "ongcPhoneRTC_receive_offer",
                value: function(t) {
                    console.log("")
                }
            }, {
                key: "ongcPhoneRTC_receive_answer",
                value: function(t) {
                    console.log("")
                }
            }]), t
    ...
    var o = n(0)(n(91), n(219), s, "data-v-def349b2", null);
    t.exports = o.exports
}, , , , function(t, e, n) {
    function s(t) {
        n(155)
    }
    var o = n(0)(n(90), n(206), s, "data-v-2804e189", null);
    t.exports = o.exports
}, , function(t, e, n) {
    "use strict";
    ...
    function o(t) {
        ...
        return a[Math.abs(e) % a.length]
    }
    e.b = s, e.a = o;
    var a = ["#448AFF", "#E040FB", "#E64A19", "#4CAF50", "#455A64", "#009688"]
}, , , , , , , , , , , , , , , , , , , , , function(t, e, n) {
    "use strict";
    var s = n(21),
        o = n(1),
    ...
    var o = n(0)(n(77), n(213), s, null, null);
    t.exports = o.exports
}, , function(t, e) {
    ...
    var s = n(23),
        ...
        v = function() {
            function t(e) {
                p()(this, t), this.phoneAPI = e, this.myPeerConnection = null, this.candidates = [], this.audio = new Audio, this.offer = null, this.answer = null, this.initiator = null, this.RTCConfig = {
                    iceServers: [{
            ...
            return d()(t, [{
                ...
                key: "newConnection",
                value: function() {
                    this.close(), this.candidates = [], this.offer = null, this.answer = null, this.initiator = null, this.myPeerConnection = new RTCPeerConnection(this.RTCConfig), this.myPeerConnection.onaddstream = this.onaddstream
                }
            }, {
                key: "close",
                value: function() {
                    ...
                    var e = l()(c.a.mark(function t() {
                        ...
                        return c.a.wrap(function(t) {
                            for (;;) switch (t.prev = t.next) {
                                ...
                                case 2:
                                    return this.newConnection(), this.initiator = !0, this.myPeerConnection.addStream(this.stream), e = new i.a(function(t, e) {
                                        n.myPeerConnection.onicecandidate = n.onicecandidatePromise(t, e)
                                    }), t.next = 8, this.myPeerConnection.createOffer();
                                case 8:
                                    return this.offer = t.sent, this.myPeerConnection.setLocalDescription(this.offer), t.abrupt("return", e);
                                case 11:
                                case "end":
                                    return t.stop()
                            }
                ...
                value: function() {
                    ...
                    var e = l()(c.a.mark(function t(e) {
                        ...
                        return c.a.wrap(function(t) {
                            for (;;) switch (t.prev = t.next) {
                                case 0:
                                    return console.log("acceptCall 1"), n = JSON.parse(atob(e.rtcOffer)), console.log("acceptCall 2"), this.newConnection(), console.log("acceptCall 3"), this.initiator = !1, console.log("acceptCall 4"), t.next = 9, navigator.mediaDevices.getUserMedia(m);
                                case 9:
                                    return this.stream = t.sent, console.log("acceptCall 5"), this.myPeerConnection.addStream(this.stream), console.log("acceptCall 5"), this.offer = new RTCSessionDescription(n.offer), console.log("acceptCall 6"), this.candidates = n.candidates, console.log("acceptCall 7"), this.myPeerConnection.setRemoteDescription(this.offer), console.log("acceptCall 8"), this.candidates.forEach(function(t) {
                                        s.myPeerConnection.addIceCandidate(t)
                                    }), console.log("acceptCall 9"), t.next = 23, this.myPeerConnection.createAnswer();
                                case 23:
                                    return this.answer = t.sent, console.log("acceptCall 10"), this.myPeerConnection.setLocalDescription(this.answer), t.abrupt("return", btoa(o()(this.answer)));
                                case 27:
                                case "end":
                                    return t.stop()
                            }
                ...
                key: "onicecandidatePromise",
                value: function(t, e) {
                    var n = this;
                    return function(e) {
                        void 0 !== e.candidate && (n.candidates.push(e.candidate), 1 === n.candidates.length && t(n.getRTCOffer()))
                    }
                }
            }, {
                key: "getRTCOffer",
                ...
                key: "onaddstream",
                value: function(t) {
                    (this.initiator = !0) || (this.audio.srcObject = t.stream, this.audio.play())
                }
            }]), t
        }();
    ...
    e.default = {
        ...
        methods: i()({}, n.i(r.a)(["setMessageRead", "sendMessage", "deleteMessage"]), {
            ...
            onActionMessage: function() {
                ...
                }].concat(o()(s))), this.ignoreControls = !0, c.a.CreateModal({
                    choix: s
                }).then(function(n) {
            ...
            onRight: function() {
                var t = this;
                !0 !== this.ignoreControls && -1 === this.selectMessage && (this.ignoreControls = !0, c.a.CreateModal({
                    choix: [{
    ...
    e.default = {
        ...
        computed: i()({}, n.i(r.b)(["myPhoneNumber", "backgroundLabel", "coqueLabel", "zoom", "config", "volume"]), {
            paramList: function() {
                return [{
                    icons: "fa-phone",
                    title: "Mon numéro",
        ...
        methods: i()({}, n.i(r.a)(["setZoon", "setBackground", "setCoque", "setVolume"]), {
            scrollIntoViewIfNeeded: function() {
                this.$nextTick(function() {
                    document.querySelector(".select").scrollIntoViewIfNeeded()
                })
            ...
            ajustZoom: function(t) {
                var e = this;
                return function() {
                    var n = Math.max(50, (parseInt(e.zoom) || 100) + t);
                    e.setZoon(n + "%")
                }
            },
            ...
            ajustVolume: function(t) {
                var e = this;
                return function() {
                    var n = Math.max(0, Math.min(1, e.volume + t));
                    e.setVolume(n)
                }
            },
    ...
    var o = n(0)(n(78), n(205), s, "data-v-26ec6c14", null);
    t.exports = o.exports
}, function(t, e, n) {
    function s(t) {
        n(167)
    }
    var o = n(0)(n(79), n(218), s, "data-v-d2b698c8", null);
    t.exports = o.exports
}, function(t, e, n) {
    function s(t) {
        n(164)
    }
    var o = n(0)(n(80), n(215), s, "data-v-9104422e", null);
    t.exports = o.exports
}, function(t, e, n) {
    function s(t) {
        n(149)
    }
    var o = n(0)(n(81), n(200), s, "data-v-0c8c5d42", null);
    t.exports = o.exports
}, function(t, e, n) {
    function s(t) {
        n(147)
    }
    var o = n(0)(n(82), n(198), s, "data-v-0570365f", null);
    t.exports = o.exports
}, function(t, e, n) {
    function s(t) {
        n(148)
    }
    var o = n(0)(n(83), n(199), s, "data-v-07b6e6d2", null);
    t.exports = o.exports
}, function(t, e, n) {
    function s(t) {
        n(163)
    }
    var o = n(0)(n(84), n(214), s, "data-v-821f15d4", null);
    t.exports = o.exports
}, function(t, e, n) {
    function s(t) {
        n(159)
    }
    var o = n(0)(n(85), n(210), s, "data-v-5d567654", null);
    t.exports = o.exports
}, function(t, e, n) {
    function s(t) {
        n(151)
    }
    var o = n(0)(n(86), n(202), s, "data-v-168e4766", null);
    t.exports = o.exports
}, function(t, e, n) {
    function s(t) {
        n(165)
    }
    var o = n(0)(n(87), n(216), s, "data-v-b3e36314", null);
    t.exports = o.exports
}, function(t, e, n) {
    function s(t) {
        n(169)
    }
    var o = n(0)(n(88), n(220), s, "data-v-e5131126", null);
    t.exports = o.exports
}, function(t, e, n) {
    function s(t) {
        n(153)
    }
    var o = n(0)(n(89), n(204), s, null, null);
    t.exports = o.exports
}, function(t, e, n) {
    function s(t) {
        n(152)
    }
    var o = n(0)(n(92), n(203), s, null, null);
    t.exports = o.exports
}, function(t, e, n) {
    function s(t) {
        n(166)
    }
    var o = n(0)(n(93), n(217), s, "data-v-d0428988", null);
    t.exports = o.exports
}, function(t, e, n) {
    function s(t) {
        n(146)
    }
    var o = n(0)(n(94), n(197), s, "data-v-01104696", null);
    t.exports = o.exports
}, function(t, e, n) {
    function s(t) {
        n(158)
    }
    var o = n(0)(n(95), n(209), s, "data-v-55f1ad54", null);
    t.exports = o.exports
}, function(t, e, n) {
    function s(t) {
        n(161)
    }
    var o = n(0)(n(96), n(212), s, "data-v-6cc9c1b2", null);
    t.exports = o.exports
}, function(t, e, n) {
    function s(t) {
        n(157)
    }
    var o = n(0)(n(97), n(208), s, "data-v-4d7b8c36", null);
    t.exports = o.exports
}, function(t, e, n) {
    var s = n(0)(n(98), null, null, null, null);
    t.exports = s.exports
}, function(t, e, n) {
    function s(t) {
        n(156)
    }
    var o = n(0)(n(99), n(207), s, "data-v-3967a7e3", null);
    t.exports = o.exports
}, function(t, e, n) {
    function s(t) {
        n(150)
    }
    var o = n(0)(n(100), n(201), s, "data-v-15f3ee32", null);
    t.exports = o.exports
}, function(t, e, n) {
    function s(t) {
        n(160)
    }
    var o = n(0)(n(101), n(211), s, "data-v-5fdffa03", null);
    t.exports = o.exports
}, function(t, e) {
    t.exports = {
        render: function() {
    ...
    t.exports = {
        render: function() {
            ...
            return n("div", {
                ...
                staticClass: "title"
            }, [t._v("# " + t._s(t.channel))]), t._v(" "), n("div", {
                ref: "elementsDiv",
                staticClass: "elements"
        ...
        render: function() {
            ...
            return n("div", {
                ...
                return n("div", {
                    ...
                    class: {
                        "subMenu-elem-select": t.currentMenuIndex === s
                    }
                }, [n("i", {
